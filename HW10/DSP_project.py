...
h = [
    ...
    0.001387902733531310,
    0.006319598995491675,
    0.016478956448270819,
    0.033262856400284965,
    0.056421923790290152,
    0.083230998421542510,
    0.108746152477792388,
    0.127188640350660020,
    0.133925940764272056,
    0.127188640350660020,
    0.108746152477792429,
    0.083230998421542565,
    0.056421923790290152,
    0.033262856400284986,
    0.016478956448270854,
    0.006319598995491683,
    0.001387902733531311,
    -0.000000000000000002,
]
...
ax1.plot(t,data1,'k')
ax1.plot(tFilter, filter[1:], 'r')
ax1.set_xlabel('Time (Sec)')
ax1.set_ylabel('Amplitude')
ax1.set_title(file + ' vs. Time, Filter: ' + filterName + ', cutoff = ' + str(cutfreq) + 'Hz, Bandwidth = ' + str(bandwidth) + 'Hz, X = '+ str(X))
